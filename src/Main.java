...
public class Main extends Application {
    ...
    public void start(Stage primaryStage){
        ...
        BinarySearchTreePane view = new BinarySearchTreePane(tree);
    ...
    public void setPane(BorderPane pane, BinarySearchTreePane view, BinarySearchTree<Integer> tree){
        pane.setCenter(view);
    ...
    public void addFunctionalities(TextField textField, Button insert, Button delete, BinarySearchTree<Integer> tree, BinarySearchTreePane view){

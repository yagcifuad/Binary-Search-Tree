...
public class BinarySearchTreePane extends Pane {
    private BinarySearchTree<Integer> tree;
    private double radius = 15;
    private double vGap = 50;

    protected BinarySearchTreePane(){ }

    BinarySearchTreePane(BinarySearchTree<Integer> tree){
        this.tree = tree;
        setStatus("Tree is empty");
        setBackground(new Background(new BackgroundFill(Color.web("#" + "90DA75"), CornerRadii.EMPTY, Insets.EMPTY)));
    }
